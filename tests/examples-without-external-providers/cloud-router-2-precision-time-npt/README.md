...
| <a name="input_precision_time_ntp_package_code"></a> [precision\_time\_ntp\_package\_code](#input\_precision\_time\_ntp\_package\_code) | Precision Time Service Package Code | `string` | n/a | yes |
