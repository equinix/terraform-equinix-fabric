...
cd terraform-equinix-fabric/examples/port-2-port-term-based-connection
terraform init
terraform apply
```
...
| <a name="input_zside_location"></a> [zside\_location](#input\_zside\_location) | Zside metro code | `string` | n/a | yes |
