...
to create a Fabric Connection from a Fabric Virtual Device to Port.
...
cd terraform-equinix-fabric/examples/virtual-device-2-port-connection
terraform init
terraform apply
```
...
| Name | Description |
|------|-------------|
| <a name="output_vd_2_port_connection"></a> [vd\_2\_port\_connection](#output\_vd\_2\_port\_connection) | n/a |
| <a name="output_vd_2_port_connection_id"></a> [vd\_2\_port\_connection\_id](#output\_vd\_2\_port\_connection\_id) | n/a |
<!-- END_TF_DOCS -->