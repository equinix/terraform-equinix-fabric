# Fabric Virtual Device to Port Connection
...
to create a Fabric Connection from a Fabric Virtual Device to Network.
...
cd terraform-equinix-fabric/examples/virtual-device-2-network-connection
terraform init
terraform apply
```
...
module "create_virtual_device_2_network_connection" {
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_create_virtual_device_2_network_connection"></a> [create\_virtual\_device\_2\_network\_connection](#module\_create\_virtual\_device\_2\_network\_connection) | equinix/fabric/equinix//modules/virtual-device-connection | n/a |
...
| <a name="input_zside_ap_type"></a> [zside\_ap\_type](#input\_zside\_ap\_type) | Access point type - NETWORK | `string` | n/a | yes |
| <a name="input_zside_network_uuid"></a> [zside\_network\_uuid](#input\_zside\_network\_uuid) | Access point network UUID | `string` | n/a | yes |

## Outputs

| Name | Description |
|------|-------------|
| <a name="output_vd_2_network_connection"></a> [vd\_2\_network\_connection](#output\_vd\_2\_network\_connection) | n/a |
| <a name="output_vd_2_network_connection_id"></a> [vd\_2\_network\_connection\_id](#output\_vd\_2\_network\_connection\_id) | n/a |
<!-- END_TF_DOCS -->