# Fabric Cloud Router to Fabric Network Connection

This example shows how to leverage the [Fabric Cloud Router Connection Module](../../modules/cloud-router-connection/README.md)
to create a Fabric Connection from a Fabric Cloud Router to Fabric Network.
...
cd terraform-equinix-fabric/examples/cloud-router-2-wan-connection
terraform init
terraform apply
```
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_cloud_router_wan_connection"></a> [cloud\_router\_wan\_connection](#module\_cloud\_router\_wan\_connection) | ../../modules/cloud-router-connection | n/a |
