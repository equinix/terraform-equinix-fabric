...
cd terraform-equinix-fabric/examples/port-2-port-connection
terraform init
terraform apply
```
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_create_port_2_port_connection"></a> [create\_port\_2\_port\_connection](#module\_create\_port\_2\_port\_connection) | ../../modules/port-connection | n/a |
