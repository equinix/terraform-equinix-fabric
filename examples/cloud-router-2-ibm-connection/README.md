...
cd terraform-equinix-fabric/examples/cloud-router-2-ibm-connection
terraform init
terraform apply
```
...
| <a name="module_create_fcr_2_ibm2_connection"></a> [create\_fcr\_2\_ibm2\_connection](#module\_create\_fcr\_2\_ibm2\_connection) | equinix/fabric/equinix//modules/cloud-router-connection | n/a |
...
| [time_sleep.wait_provider_approval](https://registry.terraform.io/providers/hashicorp/time/latest/docs/resources/sleep) | resource |
