...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_create_port_2_public_sp_connection"></a> [create\_port\_2\_public\_sp\_connection](#module\_create\_port\_2\_public\_sp\_connection) | equinix/fabric/modules/port-connection | n/a |
